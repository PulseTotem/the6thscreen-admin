...
angular.module('T6SAdmin')
  .controller('T6SAdmin.ListInfoTypeCtrl', ['$rootScope', '$scope', 'backendSocket', 'callbackManager', '$uibModal', function ($rootScope, $scope, backendSocket, callbackManager, $uibModal) {
