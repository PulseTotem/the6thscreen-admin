...
angular.module('T6SConfiguration')
  .controller('T6SConfiguration.AddCallTypeCtrlOld', ['$scope','$routeParams','backendSocket', 'callbackManager', function ($scope, $routeParams, backendSocket, callbackManager) {
